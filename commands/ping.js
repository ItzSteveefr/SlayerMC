...
module.exports = {
    ...
    async execute(interaction) {
        let circles = {
            good: '<:High:1278240682347200575> ',
            okay: '<:Mid:1278240676852535386>',
            bad: '<:Low:1278240679927091242>',
        };
        ...
        const pingEmbed = new EmbedBuilder()
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: `> <:Timer:1278240673627246663> \`${days} days, ${hours} hours, ${minutes} minutes, ${seconds} seconds\``,
                }
            );
