...
function database(message) {
    console.log(`${color.purple}[${getTimestamp()}] ${color.pink}[DATABASE]${color.reset} ${parse(message)}`);
}
...
module.exports = { getTimestamp, info, warn, error, success, database, debug, deleted, updated, created, custom };